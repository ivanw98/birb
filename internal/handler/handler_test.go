...
func TestBatchSyncOK(t *testing.T) {
	...
	srv := server(New(m, nil, nil, nil, nil, testLogger()))
...
func TestBatchSyncMalformedJSON(t *testing.T) {
	srv := server(New(&mockSightingSvc{}, nil, nil, nil, nil, testLogger()))
...
func TestBirdsOKSetsETag(t *testing.T) {
	srv := server(New(nil, birdSvc(), nil, nil, nil, testLogger()))
...
func TestBirdsConditional304(t *testing.T) {
	...
	srv := server(New(nil, bs, nil, nil, nil, testLogger()))
...
func TestBirdsServiceError500(t *testing.T) {
	...
	srv := server(New(nil, m, nil, nil, nil, testLogger()))
	rr := do(t, srv, http.MethodGet, "/birds", "")
...
func TestMeOK(t *testing.T) {
	...
	srv := server(New(nil, nil, m, nil, nil, testLogger()))
